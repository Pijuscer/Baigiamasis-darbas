...
<head>
    ...
    <header>
      ...
      <div class="container mt-4">
          ...
          <h1 class="about_pavadinimas text-center p-4">Visų vartotojų rolės</h1>
              ...
              <table class="table table_style ">
                <thead class="table_thead">
                  <tr>
                    ...
                    <th scope="col" class="th_stilius">Email</th>
                    <th scope="col" class="th_stilius">Roles</th>
                    <th scope="col"></th>
                ...
                @foreach ($users as $users2)
                  <tr class="tr_stilius">
                    <th scope="row">{{ $users2->id }}</th>
                    <td class="th_stilius">{{$users2->name }}</td>
                    <td class="th_stilius">{{$users2->email }}</td>
                    <td class="th_stilius">{{$users2->roles }}</td>
                    <td>{{ Str::limit($users2->description, 50) }}</td>
                    <td class="th_stilius">
                      <a class='no-underline btn btn-warning btn-sm' href="/all_users/edit/{{$users2->id }}">Redaguoti</a>
                    </td>
                    <td class="th_stilius">
                      <a class='no-underline btn btn-danger btn-sm' href="/all_users/remove/{{$users2->id }}">Ištrinti</a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
